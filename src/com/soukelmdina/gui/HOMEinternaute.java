 ...
 * @author marye
 */
public class HOMEinternaute extends Layout {
    EncodedImage enc;
    URLImage uRLImage;
    ...
    public Container addItem(Espace_exposition e){
        ...
        btn.addPointerPressedListener((act)->{detailinternaute int2 = new detailinternaute(e.getLibelle(),e.getDescription(),e.getPhoto(),e.getNumTel(),e.getPrix(),e.getIdsouk(),e.getLongeur(),e.getLargeur());
        int2.getF().show();
        });
