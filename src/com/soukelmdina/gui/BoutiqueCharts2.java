 ...
 * @author lina9
 */
public class BoutiqueCharts2 extends Layout {
    ...
    public BoutiqueCharts2()
    {
        ...
        f.getToolbar().addCommandToSideMenu("Stat", null,
             (ev)->{BoutiqueCharts home = new BoutiqueCharts(); home.getF().show();});
    }
    ...
    public Container addItem(Boutique1 e) {
        ...
        Label btn = new Label("Libelle " + e.getLibelle());
        //btn.addActionListener((act)->{System.out.println(e);});
        btn.addPointerReleasedListener((act) -> {            
            PieChartt hh = new PieChartt();
            Form fff = hh.PieChartt(e.getId());
            fff.show();
        });
//        btn.addPointerPressedListener((ct) -> {
//            charts ch = new charts(e.getId());
//            ch.getF().show();
