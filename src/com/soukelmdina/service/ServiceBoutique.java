...
public class ServiceBoutique {
    ...
    public int ab1(int k) {
        ...
        con.setUrl("http://localhost/soukelmdinaweb/web/app_dev.php/app/ab1/"+k);
    ...
    public int ab2(int k) {
        ArrayList<abonnement> listTasks = new ArrayList<>();
        ConnectionRequest con = new ConnectionRequest();
        con.setUrl("http://localhost/soukelmdinaweb/web/app_dev.php/app/ab2/"+k);
        con.addResponseListener(e -> {                       
            JSONParser jsonp = new JSONParser();
            try {
                Map<String, Object> tasks = jsonp.parseJSON(new CharArrayReader(new String(con.getResponseData()).toCharArray()));               
    ...
    public int ab3(int k) {
        ArrayList<abonnement> listTasks = new ArrayList<>();
        ConnectionRequest con = new ConnectionRequest();
        con.setUrl("http://localhost/soukelmdinaweb/web/app_dev.php/app/ab3/"+k);
        con.addResponseListener(e -> {                       
            JSONParser jsonp = new JSONParser();
            try {
                Map<String, Object> tasks = jsonp.parseJSON(new CharArrayReader(new String(con.getResponseData()).toCharArray()));               
    ...
    public int ab4(int k) {
        ArrayList<abonnement> listTasks = new ArrayList<>();
        ConnectionRequest con = new ConnectionRequest();
        con.setUrl("http://localhost/soukelmdinaweb/web/app_dev.php/app/ab4/"+k);
        con.addResponseListener(e -> {                       
            JSONParser jsonp = new JSONParser();
            try {
                Map<String, Object> tasks = jsonp.parseJSON(new CharArrayReader(new String(con.getResponseData()).toCharArray()));               
    ...
    public int ab5(int k) {
        ArrayList<abonnement> listTasks = new ArrayList<>();
        ConnectionRequest con = new ConnectionRequest();
        con.setUrl("http://localhost/soukelmdinaweb/web/app_dev.php/app/ab5/"+k);
        con.addResponseListener(e -> {                       
            JSONParser jsonp = new JSONParser();
            try {
                Map<String, Object> tasks = jsonp.parseJSON(new CharArrayReader(new String(con.getResponseData()).toCharArray()));               
    ...
    public int ab6(int k) {
        ArrayList<abonnement> listTasks = new ArrayList<>();
        ConnectionRequest con = new ConnectionRequest();
        con.setUrl("http://localhost/soukelmdinaweb/web/app_dev.php/app/ab6/"+k);
        con.addResponseListener(e -> {                       
            JSONParser jsonp = new JSONParser();
            try {
                Map<String, Object> tasks = jsonp.parseJSON(new CharArrayReader(new String(con.getResponseData()).toCharArray()));               
    ...
    public int ab7(int k) {
        ArrayList<abonnement> listTasks = new ArrayList<>();
        ConnectionRequest con = new ConnectionRequest();
        con.setUrl("http://localhost/soukelmdinaweb/web/app_dev.php/app/ab7/"+k);
        con.addResponseListener(e -> {                       
            JSONParser jsonp = new JSONParser();
            try {
                Map<String, Object> tasks = jsonp.parseJSON(new CharArrayReader(new String(con.getResponseData()).toCharArray()));               
    ...
    public int ab8(int k) {
        ArrayList<abonnement> listTasks = new ArrayList<>();
        ConnectionRequest con = new ConnectionRequest();
        con.setUrl("http://localhost/soukelmdinaweb/web/app_dev.php/app/ab8/"+k);
        con.addResponseListener(e -> {                       
            JSONParser jsonp = new JSONParser();
            try {
                Map<String, Object> tasks = jsonp.parseJSON(new CharArrayReader(new String(con.getResponseData()).toCharArray()));               
    ...
    public int ab9(int k) {
        ArrayList<abonnement> listTasks = new ArrayList<>();
        ConnectionRequest con = new ConnectionRequest();
        con.setUrl("http://localhost/soukelmdinaweb/web/app_dev.php/app/ab9/"+k);
        con.addResponseListener(e -> {                       
            JSONParser jsonp = new JSONParser();
            try {
                Map<String, Object> tasks = jsonp.parseJSON(new CharArrayReader(new String(con.getResponseData()).toCharArray()));               
    ...
    public int ab10(int k) {
        ArrayList<abonnement> listTasks = new ArrayList<>();
        ConnectionRequest con = new ConnectionRequest();
        con.setUrl("http://localhost/soukelmdinaweb/web/app_dev.php/app/ab10/"+k);
        con.addResponseListener(e -> {                       
            JSONParser jsonp = new JSONParser();
            try {
                Map<String, Object> tasks = jsonp.parseJSON(new CharArrayReader(new String(con.getResponseData()).toCharArray()));               
    ...
    public int ab11(int k) {
        ArrayList<abonnement> listTasks = new ArrayList<>();
        ConnectionRequest con = new ConnectionRequest();
        con.setUrl("http://localhost/soukelmdinaweb/web/app_dev.php/app/ab11/"+k);
        con.addResponseListener(e -> {                       
            JSONParser jsonp = new JSONParser();
            try {
                Map<String, Object> tasks = jsonp.parseJSON(new CharArrayReader(new String(con.getResponseData()).toCharArray()));               
    ...
    public int ab12(int k) {
        ArrayList<abonnement> listTasks = new ArrayList<>();
        ConnectionRequest con = new ConnectionRequest();
        con.setUrl("http://localhost/soukelmdinaweb/web/app_dev.php/app/ab12/"+5);
        con.addResponseListener(e -> {                       
            JSONParser jsonp = new JSONParser();
            try {
                Map<String, Object> tasks = jsonp.parseJSON(new CharArrayReader(new String(con.getResponseData()).toCharArray()));               
    ...
    public ArrayList<Boutique1> getList2() {
        ...
        ConnectionRequest con = new ConnectionRequest();
        con.setUrl("http://localhost/soukelmdinaweb/web/app_dev.php/app/allJson");
        con.addResponseListener(e -> {
    ...
    public ArrayList<Boutique1> getListParIdProprio(int k) {
        ArrayList<Boutique1> listTasks = new ArrayList<>();
        ConnectionRequest con = new ConnectionRequest();
        con.setUrl("http://localhost/soukelmdinaweb/web/app_dev.php/app/BoutiqueParIdProprio/"+k);
        con.addResponseListener(e -> {
            System.out.println("looooooooooool"+e.getLength());
            JSONParser jsonp = new JSONParser();
            try {
    ...
    public ArrayList<abonnement> chartss(){
             ArrayList<abonnement> listTasks = new ArrayList<>();
        ConnectionRequest con = new ConnectionRequest();
        con.setUrl("http://localhost/soukelmdinaweb/web/app_dev.php/app/charts1");
        con.addResponseListener(e -> {
    ...
    public void ModifTask(Boutique1 ta, int a) {
        ConnectionRequest con = new ConnectionRequest();
        String Url = "http://localhost/soukelmdinaweb/web/app_dev.php/app/ModifJson/"+a+"?libelle=" + ta.getLibelle()
                +"&description="+ta.getDescription()
                +"&numtel="+ta.getNumTel()
                +"&idsouk="+ta.getIdSouk();
        con.setUrl(Url);
    ...
    public int Like(int k) {
        ArrayList<Boutique1> listTasks = new ArrayList<>();
        ConnectionRequest con = new ConnectionRequest();
        con.setUrl("http://localhost/soukelmdinaweb/web/app_dev.php/app/nbL/"+k);
        con.addResponseListener(e -> {                       
            JSONParser jsonp = new JSONParser();
            try {
                Map<String, Object> tasks = jsonp.parseJSON(new CharArrayReader(new String(con.getResponseData()).toCharArray()));               
    ...
    public int DisLike(int k) {
        ArrayList<Boutique1> listTasks = new ArrayList<>();
        ConnectionRequest con = new ConnectionRequest();
        con.setUrl("http://localhost/soukelmdinaweb/web/app_dev.php/app/nbD/"+k);
        con.addResponseListener(e -> {                       
            JSONParser jsonp = new JSONParser();
            try {
                Map<String, Object> tasks = jsonp.parseJSON(new CharArrayReader(new String(con.getResponseData()).toCharArray()));               
    ...
    {        
        Souk1 s= new Souk1();
        ConnectionRequest con = new ConnectionRequest();
        con.setUrl("http://localhost/soukelmdinaweb/web/app_dev.php/app/souk/"+k);
        con.addResponseListener(e -> {
    ...
    public int findSouksJson2(String ch) {
        ...
        ConnectionRequest con = new ConnectionRequest();
        con.setUrl("http://localhost/soukelmdinaweb/web/app_dev.php/app/finsdSouksJson2/"+ch);
        con.addResponseListener(e -> {                       
            JSONParser jsonp = new JSONParser();
            try {
                Map<String, Object> tasks = jsonp.parseJSON(new CharArrayReader(new String(con.getResponseData()).toCharArray()));               
    ...
    public String[] findSouksJson() {
        ArrayList<abonnement> listTasks = new ArrayList<>();
        ConnectionRequest con = new ConnectionRequest();
        con.setUrl("http://localhost/soukelmdinaweb/web/app_dev.php/app/finsdSouksJson");
        con.addResponseListener(e -> {                       
            JSONParser jsonp = new JSONParser();
            try {
                Map<String, Object> tasks = jsonp.parseJSON(new CharArrayReader(new String(con.getResponseData()).toCharArray()));               
